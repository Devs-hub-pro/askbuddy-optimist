export const demoQuestions = [
  {
    id: 'demo-question-1',
    title: '测试问题：英国硕士申请时间线应该怎么安排？',
    content:
      '我计划申请 2027 年秋季入学，想先梳理语言考试、文书、实习和递交时间线。希望能得到一份适合普通学生执行的安排建议。',
    tags: ['留学', '申请', '测试'],
    bounty_points: 30,
    view_count: 186,
  ...
  {
    id: 'demo-question-2',
    title: '测试问题：没有实习经历，校招简历怎么写更有竞争力？',
    content:
      '目前还是应届生，没有正式实习，但有课程项目和社团经历。想知道如何把项目和成果写得更有说服力，避免简历太空。',
    tags: ['求职', '简历', '测试'],
    bounty_points: 20,
    view_count: 92,
    ...
    answers: [
      {
        ...
        content:
          '建议先按申请轮次倒推。先确定国家与专业方向，再安排语言考试；文书和推荐信至少提前 2 个月准备，最好留一轮修改时间。',
      ...
      },
      {
        ...
        question_id: 'demo-question-1',
        content:
          '如果预算有限，可以优先把时间投在选校和文书质量上，标化成绩不一定越高越好，关键是达到目标项目门槛。',
    ...
    answers: [
      {
        ...
        content:
          '重点写清楚项目里你做了什么、产出了什么、有没有量化结果。课程项目也可以按 STAR 结构来写，不必只盯着实习。',
...
export const demoExperts = [
  {
    ...
    user_id: 'demo-user-expert-1',
    title: '留学申请规划师',
    bio: '专注英国与新加坡硕士申请，擅长时间规划、文书修改和跨专业申请路径设计。',
    category: 'education-learning',
    subcategory: '留学',
    consultation_price: 59,
    response_time: '1小时内回复',
    experience_level: '5年经验',
    cover_image: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1200&h=480&q=80',
    tags: ['留学', '申请规划', '文书'],
    keywords: ['留学', '申请规划', '文书'],
    location: '深圳',
    rating: 4.9,
    response_rate: 98,
    order_count: 126,
    consultation_count: 208,
    followers_count: 346,
    is_verified: true,
    education: ['伦敦大学学院 硕士', '新加坡国立大学 交换经历'],
    experience: ['海外教育咨询机构 申请顾问', '独立申请规划师'],
    available_time_slots: ['工作日 19:00-22:00', '周末可约'],
    created_at: new Date().toISOString(),
    nickname: '测试留学顾问',
  ...
  },
  {
    ...
    user_id: 'demo-user-expert-2',
    title: '校招求职教练',
    bio: '聚焦校招简历、面试表达和 offer 选择，擅长帮助学生把校园经历整理成更强的求职材料。',
    category: 'career-development',
    subcategory: '求职',
    consultation_price: 49,
    response_time: '2小时内回复',
    experience_level: '4年经验',
    cover_image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=1200&h=480&q=80',
    tags: ['求职', '简历', '面试'],
    keywords: ['求职', '简历', '面试'],
    location: '深圳',
    rating: 4.8,
    response_rate: 95,
    order_count: 93,
    consultation_count: 164,
    followers_count: 212,
    is_verified: true,
    education: ['华南理工大学 本科'],
    experience: ['互联网公司 招聘培训', '校招求职辅导顾问'],
    available_time_slots: ['工作日 20:00-22:00'],
    created_at: new Date().toISOString(),
    nickname: '测试求职教练',
  ...
  },
  {
    ...
    user_id: 'demo-user-expert-3',
    title: '生活服务顾问',
    bio: '熟悉租房签约、保险选择和生活维权场景，适合解决高频生活问题与规则判断。',
    category: 'lifestyle-services',
    subcategory: '生活服务',
    consultation_price: 39,
    response_time: '1小时内回复',
    experience_level: '6年经验',
    cover_image: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=1200&h=480&q=80',
    tags: ['租房', '保险', '生活咨询'],
    keywords: ['租房', '保险', '生活咨询'],
    location: '深圳',
    rating: 4.7,
    response_rate: 93,
    order_count: 118,
    consultation_count: 176,
    followers_count: 189,
    is_verified: true,
    education: ['中山大学 本科'],
    experience: ['本地生活平台 咨询顾问', '独立生活服务答主'],
    available_time_slots: ['工作日 18:00-21:00', '周末下午可约'],
    created_at: new Date().toISOString(),
    nickname: '测试生活顾问',
  ...
  {
    id: 'demo-expert-4',
    user_id: 'demo-user-expert-4',
    title: '兴趣技能达人',
    bio: '覆盖摄影、音乐和创作入门，适合从零开始搭建兴趣成长路径与练习计划。',
    category: 'hobbies-skills',
    subcategory: '兴趣技能',
    consultation_price: 45,
    response_time: '2小时内回复',
    experience_level: '5年经验',
    cover_image: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&h=480&q=80',
    tags: ['摄影', '音乐', '创作'],
    keywords: ['摄影', '音乐', '创作'],
    location: '深圳',
    rating: 4.8,
    response_rate: 96,
    order_count: 142,
    consultation_count: 201,
    followers_count: 234,
    is_verified: true,
    education: ['广州美术学院 本科'],
    experience: ['自由创作者', '兴趣技能课程讲师'],
    available_time_slots: ['工作日 20:00-22:00', '周末全天可约'],
    created_at: new Date().toISOString(),
    nickname: '测试兴趣达人',
...
> = {
  'demo-user-expert-1': [
    {
      id: 'demo-msg-1',
      sender_id: 'demo-user-expert-1',
      receiver_id: 'current-user',
      content: '你好，我看到了你的留学问题。',
      created_at: new Date(Date.now() - 1000 * 60 * 35).toISOString(),
    },
    {
      id: 'demo-msg-2',
      sender_id: 'current-user',
      receiver_id: 'demo-user-expert-1',
      content: '我想先了解申请时间线，担心准备太晚。',
    ...
    },
    {
      ...
      sender_id: 'demo-user-expert-1',
      receiver_id: 'current-user',
      content: '可以先按申请轮次倒推，我帮你梳理一个基础时间线。',
  ...
  'demo-user-expert-2': [
    {
      id: 'demo-msg-4',
      sender_id: 'demo-user-expert-2',
      receiver_id: 'current-user',
      content: '你的简历我看过了，课程项目部分很有潜力。',
      created_at: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString(),
    },
    {
      id: 'demo-msg-5',
      sender_id: 'current-user',
      receiver_id: 'demo-user-expert-2',
      content: '我担心没有实习经历会比较吃亏。',
