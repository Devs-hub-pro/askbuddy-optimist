          ...
          <CardContent className="p-4">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3 text-center">
              <div className="rounded-2xl bg-muted px-3 py-3">
                <Users size={16} className="mx-auto text-[rgb(73,170,155)]" />
        ...
        <Card className="surface-card rounded-3xl border-none shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <ShieldCheck size={18} className="text-[rgb(73,170,155)]" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="surface-card rounded-3xl border-none shadow-sm">
          <CardContent className="grid grid-cols-3 gap-3 p-4">
            <button className="rounded-2xl bg-muted px-3 py-3 text-xs font-medium text-foreground">
              <Bell size={14} className="mx-auto mb-1 text-[rgb(73,170,155)]" />
              置顶公告
            </button>
            <button className="rounded-2xl bg-muted px-3 py-3 text-xs font-medium text-foreground">
              <FileText size={14} className="mx-auto mb-1 text-[rgb(73,170,155)]" />
              群文件
            </button>
            <button className="rounded-2xl bg-muted px-3 py-3 text-xs font-medium text-foreground">
              <Users size={14} className="mx-auto mb-1 text-[rgb(73,170,155)]" />
              群成员
            </button>
          </CardContent>
        </Card>
